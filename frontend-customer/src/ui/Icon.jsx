...
export const Ghost = (p) => <S {...p}><path d="M12 3a7 7 0 0 0-7 7v10.5l2.4-1.8 2.3 1.8 2.3-1.8 2.3 1.8 2.3-1.8 2.4 1.8V10a7 7 0 0 0-7-7Z"/><circle cx="9.5" cy="10.5" r="0.4" fill="currentColor"/><circle cx="14.5" cy="10.5" r="0.4" fill="currentColor"/></S>;
